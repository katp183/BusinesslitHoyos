...
<html>
  <head>
    <meta charset="UTF-8">
    <title>ALMACEN CJJ| Panel de Administracion</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b>CJJ</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg">ALMACEN<b></b></span>
        </a>
...
<?php endif; ?>
<?php endif; ?>
            <li><a href="./?view=sell"><i class='fa fa-usd'></i> <span>Solicitudes de material</span></a></li>
<!--            <li><a href="./?view=reandsell"><i class='fa fa-usd'></i> <span>Vender en CERO</span></a></li> -->
            ...
            <li class="treeview <?php if(isset($_GET["view"]) && ($_GET["view"]=="sells"||$_GET["view"]=="bydeliver" ||$_GET["view"]=="bycob"||$_GET["view"]=="sellscancel"||$_GET["view"]=="cotizations"||$_GET["view"]=="sellscredit"||$_GET["view"]=="onesell")){ echo "active"; }?>"   >
              <a href="#"><i class='fa fa-shopping-cart'></i> <span>Salidas</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="./?view=sells">Salidas</a></li>
<?php if(Core::$user->kind==1):?>
       
   <?php endif; ?>
                <li><a href="./?view=bydeliver">Salidas Por Entregar</a></li>
          ...
          <li><a href="./?view=rescancel">Compras canceladas</a></li>
            ...
            <?php if(Core::$user->kind==1):?>
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="./?view=categories&opt=all">Licitaciones</a></li>
                <li><a href="./?view=brands&opt=all">Marcas</a></li>
                <li><a href="./?view=clients">Dependencias</a></li>
...
<div class="login-box">
      <div class="login-logo">
        <a href="./">ALMACEN CJJ<b>LIT</b></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
      <center><h4>Dependencia</h4></center>
